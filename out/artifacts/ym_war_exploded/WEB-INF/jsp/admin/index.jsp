...
<div class="header">
    ...
    <div class="dl-log">
    		欢迎！：<span class="dl-log-user">${admin.uname }</span><a href="<%=request.getContextPath()%>/admin/quit" title="退出系统" class="dl-log-quit">[退出]</a>
    </div>
</div>
<div class="content">
...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'书籍处理',
                items:[{id:'12',text:'借书处理',href:'<%=request.getContextPath()%>/admin/show'},
                    {id:'3',text:'归还处理',href:'<%=request.getContextPath()%>/admin/backBooks'},
                    {id:'4',text:'',href:'<%=request.getContextPath()%>/admin/showReserveBook'}]
        }]}];
